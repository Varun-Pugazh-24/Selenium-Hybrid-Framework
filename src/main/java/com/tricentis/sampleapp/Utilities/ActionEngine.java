...
public class ActionEngine {
	...
	public void sendKeys_custom(WebElement element, String fieldName, String valueToBeSent) {
		try {
			...
			TestLogger.info(fieldName+"==> Ented value as: "+valueToBeSent);
		} catch (Exception e) {
	...
	public void assertEqualsString_custom(String expvalue, String actualValue, String locatorName) throws Throwable {
		try {
			if(actualValue.equals(expvalue)) {
				...
				TestLogger.info("String Assertion is successful on field "+ locatorName + " Expected value was: "+ expvalue + " actual value is: "+actualValue);
			}else {
				...
				TestLogger.error("String Assertion FAILED on field "+ locatorName + " Expected value was: "+ expvalue + " actual value is: "+actualValue);
	...
	public String getText_custom(WebElement element, String fieldName) {
		...
		try {
			...
			TestLogger.info(fieldName+"==> Text retried is: "+ text);
			return text;
		} catch (Exception e) {		
			ExtentFactory.getInstance().getExtent().log(Status.FAIL, fieldName+"==> Text not retried due to exception: "+ e);
			TestLogger.error(fieldName+"==> Text not retried due to exception: "+ e);
